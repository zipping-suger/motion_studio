"""Reshape a demo "Save Example" dir into the nested batch layout recon expects.
...
def sanitize(name: str) -> str:
    # Run name becomes the task name and a dir name; lowercase to
...
def _copy_motion_npz(src: Path, dst: Path) -> None:
    ...
    foot_contacts as float probabilities, but the contact graph
